...
const FILES = ["./", "./index.html", "./styles.css?v=banklogos-4", "./app.js?v=banklogos-4", "./manifest.webmanifest", "./icon.svg", "./icon-192.png", "./icon-512.png", "./apple-touch-icon.png", ...BANK_LOGOS];
